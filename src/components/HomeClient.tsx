...
import { getLatestBlogPostsClient, BlogPost } from '@/services/blogService';
...
const journey = [
  {
    year: '2022 – Present',
    title: 'Senior Development Consultant & Project Manager',
    company: 'Microweb Software Pvt Ltd. & Gopal Info',
    icon: '💼',
    details: [
...
export default function HomeClient({ initialBlogs }: HomeClientProps) {
  ...
  const [latestBlogs, setLatestBlogs] = useState<BlogPost[]>(initialBlogs);
  const [blogsLoading, setBlogsLoading] = useState(initialBlogs.length === 0);
  ...
  return (
    <div className="bg-[#0f0f0f] text-[#f5f5f5] min-h-screen font-sans w-full overflow-x-hidden">
      ...
      <section className="py-10 bg-[#141414] border-y border-gray-900 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6">
            <h3 className="text-sm font-bold text-[#cc5500] uppercase tracking-widest font-serif">
              WordPress Contribution History
            </h3>
          </div>
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
            {/* Core Contributor */}
            <div className="flex items-center gap-3 px-4 py-2.5 bg-[#1a1a1a] rounded-full border border-gray-800 hover:border-[#21759b] hover:shadow-[0_0_15px_rgba(33,117,155,0.15)] transition-all duration-300 group cursor-pointer" title="Core Contributor">
              <div className="w-9 h-9 rounded-full border-[1.5px] border-[#21759b] flex items-center justify-center text-[#21759b] bg-transparent group-hover:bg-[#21759b] group-hover:text-white transition-all duration-300">
                <FaWordpress size={15} />
              </div>
              <span className="text-xs sm:text-sm text-gray-300 font-semibold transition-colors duration-300 group-hover:text-[#f5f5f5]">Core Contributor</span>
            </div>

            {/* Core AI Contributor */}
            <div className="flex items-center gap-3 px-4 py-2.5 bg-[#1a1a1a] rounded-full border border-gray-800 hover:border-[#761CB9] hover:shadow-[0_0_15px_rgba(118,28,185,0.15)] transition-all duration-300 group cursor-pointer" title="Core AI Contributor">
              <div className="w-9 h-9 rounded-full border-[1.5px] border-[#761CB9] flex items-center justify-center text-[#761CB9] bg-transparent group-hover:bg-[#761CB9] group-hover:text-white transition-all duration-300">
                <FaCode size={15} />
              </div>
              <span className="text-xs sm:text-sm text-gray-300 font-semibold transition-colors duration-300 group-hover:text-[#f5f5f5]">Core AI Contributor</span>
            </div>

            {/* Photo Contributor */}
            <div className="flex items-center gap-3 px-4 py-2.5 bg-[#1a1a1a] rounded-full border border-gray-800 hover:border-[#B4009E] hover:shadow-[0_0_15px_rgba(180,0,158,0.15)] transition-all duration-300 group cursor-pointer" title="Photo Contributor">
              <div className="w-9 h-9 rounded-full border-[1.5px] border-[#B4009E] flex items-center justify-center text-[#B4009E] bg-transparent group-hover:bg-[#B4009E] group-hover:text-white transition-all duration-300">
                <FaCamera size={15} />
              </div>
              <span className="text-xs sm:text-sm text-gray-300 font-semibold transition-colors duration-300 group-hover:text-[#f5f5f5]">Photo Contributor</span>
            </div>

            {/* Translation Contributor */}
            <div className="flex items-center gap-3 px-4 py-2.5 bg-[#1a1a1a] rounded-full border border-gray-800 hover:border-[#A8106D] hover:shadow-[0_0_15px_rgba(168,16,109,0.15)] transition-all duration-300 group cursor-pointer" title="Translation Contributor">
              <div className="w-9 h-9 rounded-full border-[1.5px] border-[#A8106D] flex items-center justify-center text-[#A8106D] bg-transparent group-hover:bg-[#A8106D] group-hover:text-white transition-all duration-300">
                <MdTranslate size={15} />
              </div>
              <span className="text-xs sm:text-sm text-gray-300 font-semibold transition-colors duration-300 group-hover:text-[#f5f5f5]">Translation Contributor</span>
            </div>

            {/* Translation Editor */}
            <div className="flex items-center gap-3 px-4 py-2.5 bg-[#1a1a1a] rounded-full border border-gray-800 hover:border-[#8B1A4F] hover:shadow-[0_0_15px_rgba(139,26,79,0.15)] transition-all duration-300 group cursor-pointer" title="Translation Editor">
              <div className="w-9 h-9 rounded-full border-[1.5px] border-[#8B1A4F] flex items-center justify-center text-[#8B1A4F] bg-transparent group-hover:bg-[#8B1A4F] group-hover:text-white transition-all duration-300">
                <MdTranslate size={15} />
              </div>
              <span className="text-xs sm:text-sm text-gray-300 font-semibold transition-colors duration-300 group-hover:text-[#f5f5f5]">Translation Editor</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-16 px-4 md:px-24 scroll-mt-20">
        {sectionTitle('Testimonials')}
        <div className="max-w-4xl mx-auto mt-12">
          <motion.div
            className="group relative bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-800 hover:border-[#cc5500]/50 p-8 md:p-12 text-center"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
          >
            ...
            <div className="flex justify-center mb-6">
              <span className="text-[#cc5500]/20 group-hover:text-[#cc5500]/40 transition-colors duration-300 text-6xl md:text-7xl font-serif">
                “
              </span>
            </div>

            {/* Testimonial Content */}
            <p className="text-xl md:text-2xl text-[#f5f5f5] leading-relaxed mb-8 italic font-serif">
              Priyanka made awesome{' '}
              <a
                href="https://wordpress.org/plugins/gift-voucher/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#cc5500] hover:text-[#ff6b35] underline decoration-dotted transition-colors duration-300 inline-flex items-center gap-1.5"
                onClick={() => trackEvent('click', 'Testimonial Link', 'Gift Voucher Plugin')}
              >
                wordpress giftcard support
                <FaExternalLinkAlt className="w-3.5 h-3.5 inline-block" />
              </a>{' '}
              and handled complex issues.
            </p>

            {/* Subtle Divider */}
            <div className="w-16 h-1 bg-gradient-to-r from-transparent via-[#cc5500] to-transparent mx-auto mb-6 rounded-full" />

            {/* Author Details */}
            <div>
              <h4 className="text-lg md:text-xl font-bold text-[#f5f5f5] tracking-wide">
                Patrick Fuchshofer
              </h4>
